...
# Goal and control concepts used to describe operations.
control = LabN.control
control_action = LabN.control_action
control_type = LabN.control_type
control_value = LabN.control_value
open_blinds = LabN.open_blinds
close_blinds = LabN.close_blinds

# Action log concepts used by the proxy KG.
action_log = LabN.action_log
hasLogs = LabN.hasLogs
actionLogEntry = LabN.actionLogEntry
logBeforeState = LabN.logBeforeState
logOperation = LabN.logOperation
logAfterState = LabN.logAfterState
